...
export const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      ...
      size: {
        small: ["h-8", "px-3", "text-body-semibold-sm"],
        default: ["h-10", "px-4", "text-body-semibold-sm"],
        large: ["h-12", "px-4", "text-body-semibold-md"],
        brand: ["h-14", "px-5", "gap-3", "text-body-semibold-lg"],
      },
      fullWidth: {
        true: ["w-full"],
      },
